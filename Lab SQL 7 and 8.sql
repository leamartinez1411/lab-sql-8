...
select rental.rental_id, inventory.inventory_id, film.film_id, film.rental_duration, DATEDIFF(rental.return_date, rental_date) as rental_duration_calc 
from rental, inventory, film
where rental.inventory_id=inventory.inventory_id
and inventory.film_id=film.film_id 
and DATEDIFF(rental.return_date, rental_date)>film.rental_duration ; 
